...
public class SetEventConfigurationCommand extends AbstractCommand {

	private List<Event> enabledEvents;
	private Map<String,ValueChangeThreshold> enabledValueChanges;
	
	public SetEventConfigurationCommand() {
		super(CommandType.SetEventConfiguration);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SetEventConfigurationCommand other = (SetEventConfigurationCommand) obj;
	...
	public String toString() {
		return "SetEventConfigurationCommand [command=" + command
