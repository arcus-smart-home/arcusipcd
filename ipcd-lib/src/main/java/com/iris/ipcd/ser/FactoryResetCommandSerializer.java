...
public class FactoryResetCommandSerializer implements JsonSerializer<FactoryResetCommand> {

	@Override
	public JsonElement serialize(FactoryResetCommand cmd, Type typeOfSrc,
